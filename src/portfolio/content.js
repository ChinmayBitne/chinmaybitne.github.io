...
export const projects = [
  ...
  },
  {
    ...
    tracks: ["ai", "software"],
    summary:
      "A localhost-first Windows assistant using Gemini Live for real-time voice interaction and more than 50 local tools across applications, files, media, monitoring, reminders, and multi-step workflows.",
    ...
    contribution:
      "Building the Electron application, React and TypeScript interface, Express services, Gemini Live audio loop, local tool layer, screen-understanding path, proactive alerts, and Google Workspace integrations.",
    decisions: [
    ...
    results: [
      ...
      "Native Windows and Google Workspace integration in progress",
    ],
